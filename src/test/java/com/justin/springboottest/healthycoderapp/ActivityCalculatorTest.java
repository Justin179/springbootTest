...
class ActivityCalculatorTest {
    ...
    @Test
    void should_ThrowException_When_AvgBelowZero(){
        // given
        int weeklyCardioMins = -40;
        int weeklyWorkouts = 7;

        // when
        Executable callable = () -> ActivityCalculator.rateActivityLevel(weeklyCardioMins, weeklyWorkouts);

        // then
        assertThrows(RuntimeException.class, callable);
    }
}